...
class EdgeList(UserList, Generic[T]):
    def __init__(
        ...
        # Can only use strings as type, because of forward typing.
    ...
    @check_target_type
    def __radd__(self, other: Iterable[Edge]) -> "EdgeList":
...
#         return val
    ...
    def _init_edge(self, target_type, init_value=None):
        edge_list = EdgeList(target_type)
        if init_value:

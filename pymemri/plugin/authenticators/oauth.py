...
__all__ = ['BaseOAuthAuthenticator', 'OAuth1Authenticator', 'OAuth2Authenticator']
...
class BaseOAuthAuthenticator(metaclass=abc.ABCMeta):
...
class OAuth1Authenticator(BaseOAuthAuthenticator):
...
class OAuth2Authenticator(BaseOAuthAuthenticator):

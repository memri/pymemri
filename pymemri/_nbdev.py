...
index = {"read_file": "basic.ipynb",
         ...
         "ExampleOAuthAuthenticator": "plugin.authenticators.oauth.ipynb",
         "PasswordAuthenticator": "plugin.authenticators.password.ipynb",
         "ExamplePasswordAuthenticator": "plugin.authenticators.password.ipynb",
         ...
         "MyAPIClient": "plugin.pluginbase.ipynb",
         "MyItem": "plugin.pluginbase.ipynb",
         "MyOAuthPlugin": "plugin.pluginbase.ipynb",
         "MyPasswordPlugin": "plugin.pluginbase.ipynb",

...
index = {"read_file": "basic.ipynb",
         ...
         "Item": "itembase.ipynb",
         "RUN_STATE_POLLING_INTERVAL": "plugin.authenticated.ipynb",
         "RUN_USER_ACTION_TIMEOUT": "plugin.authenticated.ipynb",
         "AuthenticatedPlugin": "plugin.authenticated.ipynb",
         ...
         "get_plugin": "plugin.pluginbase.ipynb",

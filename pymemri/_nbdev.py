...
index = {"read_file": "basic.ipynb",
         ...
         "DataColumn": "exporters.dataset.ipynb",
         "parse_columns": "exporters.dataset.ipynb",
         "get_column_value": "exporters.dataset.ipynb",
         "get_column_values": "exporters.dataset.ipynb",
         "export_dataset": "exporters.dataset.ipynb",
